...
static void draw_objects(const cv::Mat& bgr, const std::vector<Object>& objects)
{
    ...
    cv::imwrite("yolox_trt_out.jpg", image);
}
...
int main(int argc, char* argv[])
{
    ...
    if (0 > rtt)
    {
        fprintf(stderr, "ERROR: add_context_device NV TensorRT DEVICE failed.\n");
        return -1;
    }
     fprintf(stdout, "Added Context TensorRT Device.\n");
    ...
    fprintf(stdout, "Get input tensor.\n");
